...
import com.luogang.io.client.component.CharsetByteRelative;
import com.luogang.io.client.sender.BFileSender;
import com.luogang.io.client.sender.DefaultSender;
import com.luogang.io.client.sender.FileSender;
import com.luogang.io.client.sender.GetFileSender;
import com.luogang.io.client.sender.MessageSender;
import com.luogang.io.client.sender.Sendable;
...
public class Commons {
	...
	public final static String SERVER_SAVE_BASE_PATH = "d:/javaA/upload/";

	public final static int DEFAULT_BUFFER_LENGTH =  1024;
	...
	private final static List<CharsetByteRelative> CHASET_BYTE_LIST = Arrays.asList(new CharsetByteRelative("utf8", (byte) 1), new CharsetByteRelative("gbk", (byte) 2), new CharsetByteRelative(
			"utf16", (byte) 3));
